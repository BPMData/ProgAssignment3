...
rankhospital("AK","Heart Failure", 6)
rankhospital("AK","Heart Failure", 7)
rankhospital("AK","Heart Failure", 8)
rankhospital("AK","Heart Failure", 9)
rankhospital("AK","Heart Failure", 10)
rankhospital("AK","Heart Failure", 11)
rankhospital("AK", "Heart Failure",9001)
rankhospital("AK","Heart Failure", -5)

test1 <- rankhospital("AK","Heart Failure", 9001)
test1
length(test1)
...
rankhospital("AK","Heart Failure", 2)
rankhospital("AK","Heart Failure", -2)
rankhospital("AK","Heart Failure", 200)
